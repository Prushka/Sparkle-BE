...
func TestProcess(t *testing.T) {
	...
	text, err := sub.process(inputsPairs[0], []string{
		"0:0:03.34,0:00:04.43,From my room,",
		"0:00:04.63,0:00:07.13,I can see the neighbor's backyard.",
		"0:00:07.34,0:00:19.13,It doesn't get a lot of sunlight...",
		"0:00:27.65,0:00:32.24,Rina-chan from next door is \na few years younger than I am,",
		"0:00:32.45,0:00:44.04,but apparently she's been sick all her life",
		"0:00:34.24,0:00:36.03,and never leaves the house.",
	})
	if err != nil {
