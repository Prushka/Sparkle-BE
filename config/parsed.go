...
3. Do NOT omit, merge, or split any subtitle lines. Translate every single subtitle line line-by-line from start to end. The output must contain the exact same number of subtitle lines as the input.
