...
Input: A fragment of .ass file containing subtitles in language %s.
Media: %s.
Task:
1. Replace each dialogue line text with a fluent, context‑aware %s translation, except for segments that are intentionally left untranslated.
